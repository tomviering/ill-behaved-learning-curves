...
if save_to_png
    export_fig('1_phasetransition.png',M);
end
...
if save_to_png
    export_fig('2_peaking_surface.png',M);
end
...
if save_to_png
    export_fig('4_monotonicity_squared.png',M);
end
...
if save_to_png
    export_fig('4_monotonicity_absolute.png',M);
end
...
if save_to_png
    export_fig('5_GP_regression.png',M);
end
...
if save_to_png
    export_fig('6_bayesian_regression.png',M);
end
...
if save_to_png
    export_fig('7_perfect_prior.png',M);
end
...
if save_to_png
    export_fig('8_making_monotone.png',M);
end
